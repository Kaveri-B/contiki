...
extern uint8_t pending_pkt_tx_confirm;
...
/*---------------------------------------------------------------------------*/
int
aducm3025_radio_set_channel(unsigned long channelFrequency)
{
  ADF_ChangeChans( channelFrequency );
}
/*---------------------------------------------------------------------------*/
