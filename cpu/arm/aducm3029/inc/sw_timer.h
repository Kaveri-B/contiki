...
typedef struct hw_timer_if_struct
{
    ...
    hw_tmr_init_t hw_tmr_init;/**< The function pointer for the init callback 
                                   function */
    hw_tmr_start_t hw_tmr_start;/**< The function pointer for the start callback
                                     function */
    hw_tmr_stop_t hw_tmr_stop;/**< The function pointer for stop callback 
                                   function */
    hw_tmr_get_time_t hw_tmr_get_time;/**< The function pointer for get time 
                                           callback function */
    hw_tmr_rand_t hw_tmr_rand;/**< The fucntion pointer for rand callback 
                                   function */
    hw_tmr_delay_t hw_tmr_delay;/**< The function pointer for delay callback 
                                     function */
...
typedef struct sw_tmr_module_struct
{
    ...
    list_latest_t  tmr_active_list; /**< Software Timer ACTIVE Q. Timers that are not
                          started but not expired are stored in this queue in 
                          assending order of their expire time */
    list_latest_t  tmr_exp_list; /**< Software Timer EXPIRE Q. Timers are expired but
    ...
    queue_t       isr_req_q;/**< Queue holding events raised from timer 
                                  interrupt context*/
} sw_tmr_module_t;
...
sw_tmr_create( sw_tmr_module_t *pTmr_mod_ins, sw_tmr_t *pTmr_ins,
    sw_tmr_type_t type, stime_t period, sw_tmr_cb_t cb, void* context );
 ...
 ******************************************************************************/
bool  
sw_tmr_start_with_expire( sw_tmr_module_t *pTmr_mod_ins, sw_tmr_t *pTmr_ins,
    stime_t expire_time );
 ...
 ******************************************************************************/
bool sw_tmr_stop( sw_tmr_module_t *pTmr_mod_ins, sw_tmr_t *pTmr_ins );
 ...
 *    User should pass a valid timer handle.
 ******************************************************************************/
stime_t sw_tmr_period_get( sw_tmr_module_t *pTmr_mod_ins, 
                            sw_tmr_t *pTmr_ins );
