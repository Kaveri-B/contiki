...
typedef struct _ADI_ADC_TypeDef
{
    ...
    __I __C  uint8_t  RESERVED33[6];
    __IO     uint16_t TMP_SAMP;                      /*!< Sampling Time for Temperature Sensor */
    __I __C  uint8_t  RESERVED34[30];
    __IO     uint16_t CFG1;                          /*!< Reference Buffer Low Power Mode */
    __I __C  uint8_t  RESERVED35[318];
    __IO     uint16_t TEMP1;                         /*!< Value of R1p25 */
    __I __C  uint8_t  RESERVED36[2];
    __IO     uint16_t TEMP2;                         /*!< Value of R2p5 */
    __I __C  uint8_t  RESERVED37[10];
    __IO     uint16_t TEMP_R;                        /*!< Value of R_virtual */
    __I __C  uint8_t  RESERVED38[240];
} ADI_ADC_TypeDef;
...
{
    __IO     int32_t  RST_ISR_STARTADDR;             /*!< Reset ISR Start Address */
    __IO     int32_t  RST_STACK_PTR;                 /*!< Reset Stack Pointer */
