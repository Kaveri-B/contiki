...
#define HWTIMER_SYMBOL_LENGTH   PHY_Get_Symbol_Rate() // 20 usecs for 950 MHz PHY. TBD should be a macro from PHY.h
 ...
 *    This function initializes the blackfin general purpose timer. 
...
/**
 *****************************************************************************
 * @brief Starts the initialised blackfins gp timer with the specified ticks.
...
/**
 *****************************************************************************
 * @brief Stops the running blackfin gp timer.
 * @param *phw_tmr_ins[in] - pointer to the hardware timer structure instance.
 * @retval None.
