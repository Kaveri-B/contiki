...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/ipv6/rf-module/rf-module.c</source>
      <commands>make rf-module.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>-29.66229304385481</x>
        <y>28.98908235336185</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-3.3422757155439093</x>
        <y>45.27037024639671</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>30.01075544190138</x>
        <y>65.19744221087521</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.2223024051519824 0.0 0.0 1.2223024051519824 157.5695813805083 75.47663487934726</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>GENERATE_MSG(2000, 'init-6lbr');
GENERATE_MSG(2000, 'init-6lr');
GENERATE_MSG(2000, 'init-6ln');
...
while(true) {
    YIELD();
 if(msg.equals("init-6lbr")) {
         log.log('Initializing LBR\n');
         write(sim.getMoteWithID(1), "JOIN_NETWORK 6LBR 1 0\n");
    }
    else if(msg.equals("init-6lr")) {
         log.log('Initializing LNs\n');
         write(sim.getMoteWithID(2), "JOIN_NETWORK 6LR 1 0\n");
    }
    else if(msg.equals("init-6ln")) {
         log.log('Initializing LNs\n');
         write(sim.getMoteWithID(3), "JOIN_NETWORK 6LN 1 0\n");
    } 
